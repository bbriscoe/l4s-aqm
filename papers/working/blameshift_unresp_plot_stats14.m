...
plot(beta(1,:), p_stats(1,:,1,1,1),  "--;p_{sa}: λ_a=^{1}/_{16};", "color", [0.6 0.6 0.6], ...
     ...
     beta(1,:), p_stats(3,:,1,1,1),   ":;p_{sa}: λ_a=^{3}/_{16};", "color", "magenta", "linewidth", 2.5, ...
     beta(1,:), p_stats(4,:,1,1,1),  "--;p_{sa}: λ_a=^{4}/_{16};", "color", "magenta", ...
     beta(1,:), p_stats(5,:,1,1,1),   "-;p_{sa}: λ_a=^{5}/_{16};", "color", "magenta", ...
     beta(1,:), p_stats(6,:,1,1,1),   ":;p_{sa}: λ_a=^{6}/_{16};", "color", "blue", "linewidth", 2.5, ...
     beta(1,:), p_stats(7,:,1,1,1),  "--;p_{sa}: λ_a=^{7}/_{16};", "color", "blue", ...
     beta(1,:), p_stats(8,:,1,1,1),   "-;p_{sa}: λ_a=^{8}/_{16};", "color", "blue", ...
     beta(1,:), p_stats(9,:,1,1,1),   ":;p_{sa}: λ_a=^{9}/_{16};", "color", [0.6 0 0.6], "linewidth", 2.5,  ...
     beta(1,:), p_stats(10,:,1,1,1), "--;p_{sa}: λ_a=^{10}/_{16};", "color", [0.6 0 0.6],  ...
     beta(1,:), p_stats(11,:,1,1,1),  "-;p_{sa}: λ_a=^{11}/_{16};", "color", [0.6 0 0.6], ...
     beta(1,:), p_stats(12,:,1,1,1),  ":;p_{sa}: λ_a=^{12}/_{16};", "color", "black", "linewidth", 2.5, ...
     beta(1,:), p_stats(13,:,1,1,1), "--;p_{sa}: λ_a=^{13}/_{16};", "color", "black", ...
...
# plot p_e
figure(2)
plot(beta(1,:), p_stats(1,:,1,2,1),  "--;p_{ea}: λ_a=^{1}/_{16};", "color", [0.6 0.6 0.6], ...
     beta(1,:), p_stats(2,:,1,2,1),   "-;p_{ea}: λ_a=^{2}/_{16};", "color", [0.6 0.6 0.6], ...
     beta(1,:), p_stats(3,:,1,2,1),   ":;p_{ea}: λ_a=^{3}/_{16};", "color", "magenta", "linewidth", 2.5, ...
     beta(1,:), p_stats(4,:,1,2,1),  "--;p_{ea}: λ_a=^{4}/_{16};", "color", "magenta", ...
     beta(1,:), p_stats(5,:,1,2,1),   "-;p_{ea}: λ_a=^{5}/_{16};", "color", "magenta", ...
     beta(1,:), p_stats(6,:,1,2,1),   ":;p_{ea}: λ_a=^{6}/_{16};", "color", "blue", "linewidth", 2.5, ...
     beta(1,:), p_stats(7,:,1,2,1),  "--;p_{ea}: λ_a=^{7}/_{16};", "color", "blue", ...
     beta(1,:), p_stats(8,:,1,2,1),   "-;p_{ea}: λ_a=^{8}/_{16};", "color", "blue", ...
     beta(1,:), p_stats(9,:,1,2,1),   ":;p_{ea}: λ_a=^{9}/_{16};", "color", [0.6 0 0.6], "linewidth", 2.5,  ...
     beta(1,:), p_stats(10,:,1,2,1), "--;p_{ea}: λ_a=^{10}/_{16};", "color", [0.6 0 0.6],  ...
     beta(1,:), p_stats(11,:,1,2,1),  "-;p_{ea}: λ_a=^{11}/_{16};", "color", [0.6 0 0.6], ...
     beta(1,:), p_stats(12,:,1,2,1),  ":;p_{ea}: λ_a=^{12}/_{16};", "color", "black", "linewidth", 2.5, ...
     beta(1,:), p_stats(13,:,1,2,1), "--;p_{ea}: λ_a=^{13}/_{16};", "color", "black", ...
